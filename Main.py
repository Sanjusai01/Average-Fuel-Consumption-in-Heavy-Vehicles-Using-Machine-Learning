...
font = ('times', 16, 'bold')
title = Label(main, text='Average Fuel Consumption in Heavy Vehicles Using Machine Learning')
title.config(bg='indigo', fg='tan')  
...
font1 = ('times', 15, 'bold')
uploadButton = Button(main, text="Upload  Vehicles Fuel Dataset", command=upload)
